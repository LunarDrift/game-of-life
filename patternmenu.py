...
class PatternMenu:
        ...
        self.categories = [
            {
                ...
                "patterns": [
                    {
                        "label": "Blinker",
                        "file": "patterns/blinker.cells",
                    },
                    {
                        "label": "Pulsar",
                        "file": "patterns/pulsar.cells",
                    },
                ],
            },
            {
                ...
                "patterns": [
                    {
                        "label": "Glider",
                        "file": "patterns/glider.cells",
                    },
                    {
                        "label": "Lightweight Spaceship",
                        "file": "patterns/lwss.cells",
                    },
                ],
            },
            {
                ...
                "patterns": [
                    {
                        ...
                        "file": "patterns/gosperglidergun.cells",
                    },
                    {
                        "label": "R-pentomino",
                        "file": "patterns/rpentomino.cells",
                    }
                ],
            }
        ]
    ...
    def _draw_pattern_button(self, screen, rect, label):
        ...
        for category in self.categories:
            ...
            screen.blit(
                title_txt,
                (self.panel_rect.centerx - title_txt.get_width() // 2, y)
            )
            y += 25
